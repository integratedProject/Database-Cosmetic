...
insert into product values('DL01','Rouge Dior','DL01_fuchcia.jpg',
                            ...
                            ,'B02');
insert into product values('DL02','Rouge Dior The Refill','DL02_OseeSatin.jpg',
                            ...
                            ,'B02');
insert into product values('DL03','Rouge Dior Forever Liquid','DL03_HotPink.jpg',
...
insert into product values('DB01','Dior Forever Natural Bronze','DB01_peach.jpg',
                            ...
                            ,'B02');
insert into product values('DB02','Rouge Blush','DB02_Peach.jpg',
                            ...
                            ,'B02');
insert into product values('DB03','Dior Backstage Rosy Glow','DB03_Plum.jpg',
...
insert into product values('DE01','5 COULEURS COUTURE','DE01_Bronze.jpg',
                            ...
                            ,'B02');
insert into product values('DE02','5 COULEURS COUTURE - SUMMER DUNE','DE02_NudePink.jpg',
                            ...
                            ,'B02');
insert into product values('DE03','5 COULEURS DESIGNER','DE03_Rosy.jpg',
...
insert into product values('CL01','Rouge coco bloom','CL01_Zenith.jpg',
                            ...
                            ,'B01');
insert into product values('CL02','Rouge coco','CL02_Coco.jpg',
                            ...
                            ,'B01');
insert into product values('CL03','Rouge allure ink','CL03_OrengeRed.jpg',
...
insert into product values('CB01','Palette essentielle','CB01_Rosy.jpg',
                            ...
                            ,'B01');
insert into product values('CB02','Palette essentielle','CB02_NudePink.jpg',
                            ...
                            ,'B01');
insert into product values('CB03','Joues contraste','CB03_NudeOrenge.jpg',
...
insert into product values('CE01','Les 4 ombres','CE01_NudeOrenge.jpg',
                            ...
                            ,'B01');
insert into product values('CE02','Les 4 ombres','CE02_SilverGold.jpg',
                            ...
                            ,'B01');
insert into product values('CE03','Ombre premiere top coat','CE03_Peach.jpg',
...
insert into product values('NL01','Nars Lipstick','NL01_OrengePeach.jpg',
                            ...
                            ,'B03');
insert into product values('NL02','The iconic lip bundle','NL02_NudePink.jpg',
                            ...
                            ,'B03');
insert into product values('NL03','Audacious lipstick','NL03_PartyRed.jpg',
...
insert into product values('NB01','Nars Blush','NB01_NudePink.jpg',
                            1500.00,'2019-02-17','The ultimate authority in blush, nars offers the industrys most iconic shades for cheeks.'
                            ,'B03');
insert into product values('NB02','Air matte blush','NB02_RoseGold.jpg',
                            ...
                            ,'B03');
insert into product values('NB03','The multiple','NB03_NudePink.jpg',
                            1100.00,'2019-09-19','Franois nars iconic innovation, its the original multi-purpose stick for eyes, cheeks, lips and body. '
                            ,'B03');

                            
                            
insert into product values('NE01','Summer solstice eyeshadow palette','NE01_RoseGold.jpg',
                            1000.00,'2019-03-13','A limited-edition eyeshadow palette featuring nine rich bronze and golden tones.'
                            ,'B03');
insert into product values('NE02','Uninhibited eyeshadow palette','NE02_LuminousGold.jpg',
                            ...
                            ,'B03');
insert into product values('NE03','The orgasm bundle','NE03_RedPlum.jpg',
